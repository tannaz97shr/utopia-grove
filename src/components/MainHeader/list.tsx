  ...
  return (
    <>
      ...
      <div
        ...
        }  w-[90%] md:w-fit flex-col md:flex-row absolute md:relative top-28 md:top-0 bg-beige border transform -translate-x-1/2 md:border-none p-4 md:p-0 h-[70vh] md:h-fit ml-auto left-1/2 md:left-[unset]`}
      >
        ...
        hover:cursor-pointer hover:text-maroon hover:border-b-4 hover:border-maroon"
            >

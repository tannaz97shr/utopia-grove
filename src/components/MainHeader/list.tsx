...
export default function NavbarList() {
  ...
  return (
    <>
      ...
      <div
        className="flex w-[90%] md:flex-1 flex-col md:flex-row absolute md:relative top-28 md:top-0 bg-bg-primary
  border md:border-none p-4 md:p-0 h-[70vh] md:h-fit"
      >
        <ul className="flex md:mt-auto md:ml-16 flex-col md:flex-row items-center">
          {listItems.map((item) => (
            <li
              key={item.id}
